...
<tr>
	...
	<td>
      ...
      <input type="button" class="btn btn-info btn-xs" value="ID중복확인" onclick="idCheck()">
	</td>
</tr>
...
<tr>
	<td colspan="2" style= text-align:center;>
		...
		<input type="reset"  value="취소"  class="btn btn-default" div onclick="location.href='http://hje9418.cafe24.com/index.jsp'"></div>
	</td>
</tr>
</table>
